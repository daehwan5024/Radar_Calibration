function [posCalibrated] = getCalibratePDOP2(distMeasured, num_radar, num_bottom)
    ...
    orders = getInsertOrder(pdopList, num_radar+num_bottom);
    posCalibrated = zeros(3, num_radar+num_bottom);
    ...
    for grad_iter=1:500000 % gradient descent
        ...
        for i= 1:num_radar+num_bottom
            loss_t = zeros(3, 1);
            for j=1:num_radar+num_bottom
                if i==j
                    continue
                end
